...
# Plugins
$Plugins = @(
"https://github.com/monun/auto-reloader/releases/latest/download/auto-reloader-0.0.6.jar", #autoreloader
"https://github.com/komq-babo/Stone-Battle/releases/latest/download/Stonebattle-2Match.jar", #stonebattle
"https://drive.usercontent.google.com/u/0/uc?id=1PUvxoSh8vAARL2afP2p_7hvYVHUedaEI&export=download" #worldedit
)
...
# Run
$ServerJarURL = "https://clip.aroxu.me/download?mc_version=$Version" #paper
