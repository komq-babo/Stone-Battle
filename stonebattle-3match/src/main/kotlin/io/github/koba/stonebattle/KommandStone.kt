...
object KommandStone {
    ...
    var team3bar: BossBar? = null

    var team1: String? = null
    var team2: String? = null
    var team3: String? = null
                ...
                executes {
                    if (!game) {
                        ...
                        for (team in Bukkit.getScoreboardManager().mainScoreboard.teams) {
                            ...
                            if (i == 3) {
                                team3bar = Bukkit.createBossBar(team.name, BarColor.WHITE, BarStyle.SOLID)
                                team3bar?.progress = 1.0
                                team3 = team.name
                                break
                            }
                            i += 1
